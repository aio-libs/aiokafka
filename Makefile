...
ci-test-unit:
	py.test -s --log-level DEBUG --cov aiokafka --cov-report xml $(FLAGS) tests

ci-test-all:
	py.test -s -v --log-level DEBUG --cov aiokafka --cov-report xml --docker-image $(DOCKER_IMAGE) $(FLAGS) tests
